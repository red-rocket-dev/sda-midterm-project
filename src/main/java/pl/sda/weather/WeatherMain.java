...
public class WeatherMain {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        userDto.save(new UserEntity());

        final OpenWeatherMapHttpClient openWeatherMapHttpClient = new OpenWeatherMapHttpClient();
        //openWeatherMapHttpClient.getWeatherString();
